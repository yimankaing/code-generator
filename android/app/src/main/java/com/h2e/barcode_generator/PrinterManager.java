...
import com.h2e.barcode_generator.bluetooth_printer.DeviceListActivity;
import com.h2e.barcode_generator.bluetooth_printer.PrintPicture;
...
public class PrinterManager extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  void printInvoice(String imagePath, Callback callback) {
    ReactApplicationContext context = getReactApplicationContext();
